...
const cases: Array<{
  ...
  // Регрессия из ревью Kimi: «не» короче трёх букв и выпадало из термов, из-за
  // чего противоположные по смыслу вопросы давали пересечение 1.00.
  {
    name: 'ОТРИЦАНИЕ: «не нужен» не должен получить ответ на «нужен»',
    question: 'Не нужен ли оригинал для нотариального заверения?',
    candidate: 'Нужен ли оригинал для нотариального заверения?',
    shouldOverride: false,
  },
  {
    name: 'ОТРИЦАНИЕ: «можно ли не» не должен получить ответ на «можно ли»',
    question: 'Можно ли не апостилировать справку в Санкт-Петербурге?',
    candidate: 'Можно ли апостилировать справку в Санкт-Петербурге?',
    shouldOverride: false,
  },
  {
    name: 'ОТРИЦАНИЕ: «без апостиля» против «с апостилем»',
    question: 'Сколько стоит справка о несудимости без апостиля?',
    candidate: 'Сколько стоит справка о несудимости с апостилем?',
    shouldOverride: false,
  },
  {
    name: 'ОТРИЦАНИЕ с обеих сторон — подмена допустима',
    question: 'Не нужен ли оригинал документа для заверения перевода?',
    candidate: 'Не нужен ли оригинал документа для заверения и сшития перевода',
    shouldOverride: true,
  },
];
