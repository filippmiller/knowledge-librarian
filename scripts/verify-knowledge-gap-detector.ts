...
const cases: Array<{ answer: string; expected: boolean; name: string }> = [
  ...
  {
    name: 'реальный ответ с прода 30.07 — уверенное «можно», затем признание пробела',
    expected: true,
    answer:
      'Справку о несудимости, выданную в Саратовской области, можно апостилировать в Санкт-Петербурге. Однако в источниках не указано, может ли МВД или МЮ СПб проставить апостиль на справку, выданную в другом регионе. Для точного ответа рекомендую уточнить напрямую.',
  },
  {
