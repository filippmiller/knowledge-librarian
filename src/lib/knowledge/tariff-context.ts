...
const MONEY_TOPIC =
  /сколько\s+стоит|стоимост|цена|цену|цены|прайс|тариф|почём|почем|платн|бесплатн|дешевл|дорож|скидк|доплат|наценк|обойдётся|обойдется|расцен|оплат|сколько\s+будет|во\s+сколько/iu;
