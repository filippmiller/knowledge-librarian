...
export const TRIGGER_FACT_REGISTRY = {
  ...
  resourceAvailability: {
    ...
    description:
      'доступен ли расходуемый ресурс/материал, необходимый для основного способа выполнения действия. ' +
      'Ставить ТОЛЬКО когда в самом тексте прямо сказано о наличии или отсутствии такого ресурса ' +
      '(например «при отсутствии воды допустим антисептик»). Безусловный запрет или оценка способа ' +
      'действия, где ресурс не упомянут, этим фактом НЕ описывается — оставь triggerCondition=null',
  },
