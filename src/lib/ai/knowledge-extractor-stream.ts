...
а столбцы = сроки (стандарт, через 1 день, следующий день, в день приема, два часа):

ЗАПРЕЩЕНО: создавать по 1 правилу на каждую ячейку (т.е. 5+ правил на один язык)
ОБЯЗАТЕЛЬНО: создать ОДНО правило на один язык, включив ВСЕ сроки в body

ПРАВИЛЬНО (одно правило на язык):
{
  "ruleCode": "R-NNN",
  "title": "Тарифы на перевод с английского языка",
  "body": "стандарт: 630 руб (с НЗ 1540 руб); через 1 день: 720 руб (с НЗ 1630 руб); следующий день: 830 руб (с НЗ 1740 руб); в день приема: 1110 руб (с НЗ 2020 руб); два часа: 1270 руб (с НЗ 2180 руб).",
  "sourceSpan": { "quote": "АНГЛИЙСКИЙ 630 1540 | 720 1630 | 830 1740 | 1110 2020 | 1270 2180" }
}

НЕПРАВИЛЬНО (5 правил на один язык — так делать нельзя):
R-NNN: Цена английского стандарт → R-NNN+1: Цена английского через 1 день → …
