 ...
 * 👎 фиксирует расхождение, ✍ просит сотрудника прислать правильный текст
  ...
  try {
    ...
    if (text === '/start') {
      await sendTestMessage(
        ...
        'плюс ближайший реальный ответ оператора рядом. Отметьте 👍/👎, или ✍ и пришлите верный текст следующим сообщением.'
      );
      return NextResponse.json({ ok: true });
    }
    ...
    await sendTestMessage(chatId, reply, [
      ...
      { text: '✍ дать правильный ответ', callback_data: 'fb:correct' },
    ]);
